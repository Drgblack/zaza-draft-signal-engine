...
test("buildVideoFactoryReviewJob keeps the current reviewable attempt when later history exists", () => {
  ...
  opportunity.generationState?.runLedger.push({
    ...
    autonomyPolicyReason: null,
    autonomyPolicyRiskLevel: null,
    growthExecutionPath: "review",
    growthExecutionPriority: 41,
    growthRiskLevel: "medium",
    growthReasoning: "Impact potential 58/100; risk medium; execution path review",
