...
export const AUDIT_EVENT_TYPES = [
  ...
  "CONTENT_OPPORTUNITY_FOUNDER_SELECTION_UPDATED",
  "CONTENT_OPPORTUNITY_VIDEO_BRIEF_APPROVED_FOR_GENERATION",
  "CONTENT_OPPORTUNITY_VIDEO_GENERATION_STARTED",
  "CONTENT_OPPORTUNITY_VIDEO_REGENERATED",
  "CONTENT_OPPORTUNITY_RENDER_COMPLETED",
  "CONTENT_OPPORTUNITY_ASSET_REVIEW_UPDATED",
  "CONTENT_OPPORTUNITY_ASSET_DISCARDED",
  "CONTENT_OPPORTUNITY_PRODUCTION_PACKAGE_EXPORTED",
  "PRODUCTION_DEFAULTS_UPDATED",
